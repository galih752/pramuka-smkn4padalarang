...
<html>
    ...
    <center><input type="submit" value="EXPORT EXCEL" onclick="window.open('anggota-excel.php')" style="margin-top: 20px; background-color:rgb(4, 87, 38); border:2px solid white; border-radius:10px; width: 150px; height:28px; color:white;" ></center>
    </body>
<?php
if(isset($_GET['kode'])){
    mysqli_query($koneksi, "delete from anggota where id='$_GET[kode]'");
