...
<body>
    ...
    <h3 style="font-family:comic sans ms;color:white; text-align:center;" align="center">PENGUMPULAN TUGAS</h3>
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <tr>
            <td style="color:white;">Tugas Ke</td>
            <td align="center" style="color:white;">:</td>
            <td><input type="text" name="id" style="background-color:rgb(4, 87, 38); border:1px solid white; border-radius:5px; width: 150px; height:20px; color:white;"></td>
        </tr>
        <tr>
            <td style="color:white;">Nama</td>
            <td align="center" style="color:white;">:</td>
            <td><input type="text" name="nama" style="background-color:rgb(4, 87, 38); border:1px solid white; border-radius:5px; width: 150px; height:20px; color:white;"></td>
        </tr>
        <tr>
            <td style="color:white;">File</td>
            <td align="center" style="color:white;">:</td>
            <td><input type="file" name="file" style="border: 2px solid #ffff; width:181px;color:white; height:21px;border-radius:5px;"></td>
        </tr>
        <tr>
            <td></td>
...
if(isset($_POST['proses'])){
    $directory = "../pengumpulan/";
    $file_name = $_FILES['file']['name'];
    $tanggal = date("Y-m-d H:i:s");
    move_uploaded_file($_FILES['file']['tmp_name'],$directory.$file_name);

    mysqli_query($koneksi, "insert into pengumpulan set
    id = '$_POST[id]',
