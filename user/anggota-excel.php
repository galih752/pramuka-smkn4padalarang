...
<html>
    ...
    <body>
        <center><h1 id="judul" style=" font-family:comic sans ms; text-align : center;">ANGGOTA PRAMUKA SMKN 4 PADALARANG</h1></center>
        <div id="data">
        <table style="margin-bottom : 10px; margin-left:auto;margin-right:auto; box-shadow: 4px 4px 6px #333; width:550; height:100;" border="1">
            <b><tr>
                <th>No</th>
                <th>Nama</th>
                <th>Kelas</th>
