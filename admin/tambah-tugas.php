...
<div class="container">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <tr>
            ...
            <td><input type="text" name="subject" style="background-color:rgb(4, 87, 38); border:1px solid white; border-radius:5px; width: 200px; height:20px; color:white;" placeholder="Masukkan Judul Tugas.."></td>
        </tr>
        <tr>
            <td style="color:white;">Soal</td>
            <td align="center" style="color:white;">:</td>
            <td><input type="text" name="soal" style="background-color:rgb(4, 87, 38); border:1px solid white; border-radius:5px; width: 200px; height:100px; color:white;" placeholder="Masukkan Perintah Tugas.."></td>
        </tr>
        <tr>
