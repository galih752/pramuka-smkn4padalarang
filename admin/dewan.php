...
<html>
    ...
    <body>
        ...
        <h1 style="font-family:comic sans ms; text-align : center; color:white;">DEWAN AMBALAN PRAMUKA SMKN 4 PADALARANG</h1>
        ...
        while ($tampil = mysqli_fetch_array($ambil)){
            ...
            <tr>
                ...
                <td style='text-align:center;'><a href='ubah_dewan.php?id=$tampil[id]' style='color:white; text-decoration:none;'> <input type='button' class='edit'></a></td>
            </tr>";
